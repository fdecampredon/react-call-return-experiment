 ...
 *
 * @noflow
 * @providesModule ReactTestRenderer-dev
 * @preventMunge
 */
...
function getUpdateExpirationTime$1(fiber) {
  if (fiber.tag !== ClassComponent$7 && fiber.tag !== HostRoot$7) {
    return NoWork$5;
  }
...
var ReactTestInstance = function () {
  ReactTestInstance.prototype._currentFiber = function _currentFiber() {
    ...
    invariant(fiber !== null, "Can't read from currently-mounting component. This error is likely " + 'caused by a bug in React. Please file an issue.');
    return fiber;
  };
  ...
  function ReactTestInstance(fiber) {
    ...
    invariant(validWrapperTypes.has(fiber.tag), 'Unexpected object passed to ReactTestInstance constructor (tag: %s). ' + 'This is probably a bug in React.', fiber.tag);
    this._fiber = fiber;
  }
...
var ReactTestRenderer = ReactTestRendererFiber;

var index = ReactTestRenderer;
