...
function findCurrentFiberUsingSlowPath(fiber) {
  ...
  // unmounted.
  !(a.tag === HostRoot$2) ? invariant(false, 'Unable to find node on an unmounted component.') : void 0;
...
var findCurrentUnmaskedContext$1 = function (fiber) {
  ...
  !(isFiberMounted(fiber) && fiber.tag === ClassComponent$1) ? invariant(false, 'Expected subtree parent to be a mounted class component. This error is likely caused by a bug in React. Please file an issue.') : void 0;
